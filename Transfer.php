...
<head>
    ...
    <style>
        ...
        .transferMoney {
            color: white;
            background: #fa9511;
            background: -webkit-linear-gradient(to bottom, #fa9511, #bf10eb);
            background: linear-gradient(to bottom, #fa9511, #95c728);
            padding: 20px;
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        <form name="myForm" action="ResultPage.php" onsubmit="return validateForm()" method="post">
            ...
            <table id="table1">
                ...
                <tr>
                    ...
                    <td><input type="number" name="payerID" min=100 required>
                    <td>
                </tr>
                <!-- ROW 2 : PAYEE ACCOUNT ID IS ASKED-->
                <tr>
                    <td>Payee Account No</td>
                    <td><input type="number" name="payeeID" min=100 required>
                    <td>
                </tr>
                <!-- ROW 3 : AMOUNT TO BE TRANSFERRED IS ASKED-->
                <tr>
                    <td>Amount (in Rupees)</td>
                    <td><input type="number" name="amount" min=1 required>
                    <td>
                </tr>
